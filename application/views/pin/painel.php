  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <!--?php } ?>!-->
            <li class="bg_ly"> <a href="<?php echo base_url()?>index.php/transacoes"> <i class="icon-signal"></i> Transaçoes Financeiras </a> </li>
...
<?php /*if ($estatisticas_financeiro != null) {
    if ($estatisticas_financeiro->total_receita != null || 
        $estatisticas_financeiro->total_despesa != null || 
        $estatisticas_financeiro->total_receita_pendente != null || 
        $estatisticas_financeiro->total_despesa_pendente != null) {  
 * 
 */
 ?>
<!--<div class="row-fluid" style="margin-top: 0">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="row-fluid">           
                    <div class="span12">
                       <ul class="site-stats">
                                  <li class="bg_lh"><i class="icon-group"></i> <strong>0</strong> <small>Clientes Investidores</small></li>
                            <li class="bg_lh"><i class="icon-barcode"></i> <strong>0</strong> <small>Clientes Empreendedores </small></li>
                            <li class="bg_lh"><i class="icon-tags"></i><strong>0</strong> <small>Transações Financeiras</small></li>
                            <li class="bg_lh"><i class="icon-wrench"></i><strong>0</strong><small>Relatórios</small></li>

                     <!--      <li class="bg_lh"><i class="icon-group"></i> <strong><?php// echo $this->db->count_all('clientes');?></strong> <small>Clientes Investidores</small></li>
                            <li class="bg_lh"><i class="icon-barcode"></i> <strong><?php// echo $this->db->count_all('produtos');?></strong> <small>Clientes Empreendedores </small></li>
                            <li class="bg_lh"><i class="icon-tags"></i> <strong><?php //echo $this->db->count_all('os');?></strong> <small>Transações Financeiras</small></li>
                            <li class="bg_lh"><i class="icon-wrench"></i> <strong><?php// echo $this->db->count_all('servicos');?></strong> <small>Relatórios</small></li>
                         !-->   
                        </ul>
                    </div>
