...
<head>
    ...
    <body>
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo site_url()?>/mine/login1">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"></i></span><input id="documento" name="docomento" type="text" placeholder="CPF/CPNJ" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-star"></i></span><input class="cpf" name="documento" type="text" placeholder="senha" />
                        </div>
                    </div>
                </div>
                <div class="form-actions" style="text-align: center">
                    <button class="btn btn-info btn-large"/> Acessar</button>
                    <a href="<?= site_url('mine/escolha') ?>" class="btn btn-success btn-large">Cadastrar-me</a>
                </div>
            </form>
