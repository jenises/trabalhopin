<div class="widget-box">
    <div class="widget-title">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab1">Dados do Cliente Investidor</a></li>
            <li><a data-toggle="tab" href="#tab2">Empresas Investidas</a></li>
            <div class="buttons">
            ...
            <?php if (!$results) { ?>
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6">Nenhuma Empresa Emprendedora Encontrada</td>
                                </tr>
                            </tbody>
                        </table>
