...
<head>
        <title>Pin Smart Invest Logar</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/ClienteInvest/verificarLogin">
